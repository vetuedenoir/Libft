...
**
** Notes :
** - La fonction write est utilisée pour écrire le caractère sur le flux de sortie
** spécifié par le descripteur de fichier fd.
** - Le caractère est passé en référence à la fonction write, avec une taille de 1
** octet.
*/

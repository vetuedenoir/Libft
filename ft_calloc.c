...
**
** Remarques :
**  - La zone mémoire allouée par cette fonction doit être libérée avec la fonction free().
**  - Le comportement est indéfini si nmemb ou size valent zéro, ou si l'allocation échoue.
**  - Le comportement est indéfini si le produit nmemb * size dépasse la capacité de size_t.
*/
